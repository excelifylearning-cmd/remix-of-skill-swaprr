                ...
                <div className="flex items-center justify-between border-b border-border px-4 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="flex items-center gap-1 text-[10px] text-skill-green"><span className="h-1.5 w-1.5 rounded-full bg-skill-green" />Online</p>
                    </div>
                  </div>
                  <button onClick={() => setChatOpen(false)} className="text-muted-foreground hover:text-foreground"><X size={16} /></button>
                </div>
